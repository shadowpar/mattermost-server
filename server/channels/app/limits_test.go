...
func TestGetServerLimits(t *testing.T) {
	...
	t.Run("unlicensed server has no user limits", func(t *testing.T) {
...
func TestIsAtUserLimit(t *testing.T) {
	...
	t.Run("unlicensed server", func(t *testing.T) {
		t.Run("below former hard limit", func(t *testing.T) {
		...
		t.Run("does not enforce former hard limit", func(t *testing.T) {
			th := SetupWithStoreMock(t)
		...
		t.Run("does not enforce above former hard limit", func(t *testing.T) {
			th := SetupWithStoreMock(t)
...
func TestExtraUsersBehavior(t *testing.T) {
	...
	t.Run("unlicensed server has no user limits or extra users", func(t *testing.T) {
		th := Setup(t).InitBasic(t)
